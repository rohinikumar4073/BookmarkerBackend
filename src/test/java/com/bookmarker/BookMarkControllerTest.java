...
public class BookMarkControllerTest {
	...
	public void loadBrowserData() throws Exception {
	    ...
	    String jsonString=new Gson().toJson(new BrowserDataList("",""));
		mvc.perform(post("/browserData").contentType(MediaType.APPLICATION_JSON).content(jsonString)).andExpect(status().isOk())
